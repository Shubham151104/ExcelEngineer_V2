        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <p className="text-lg mb-6">
              ...
              parts and components, serving industries worldwide since 2005. Our
              commitment to quality, innovation, and customer satisfaction has
              made us a trusted partner in the boiler manufacturing industry.
            </p>
            <p className="text-lg mb-6">
              With state-of-the-art facilities and a team of expert engineers,
              we deliver precision-engineered solutions that meet the highest
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {["Quality", "Innovation", "Customer Focus"].map((value) => (
            ...
            >
              ...
              <p>
                Brief description of how we embody this value in our work and
                products.
              </p>
            </div>
          ))}
