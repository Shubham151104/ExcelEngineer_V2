...
const projects = [
  {
    ...
    image: "/project1.jpeg",
    fullDescription:
      "This state-of-the-art solar power plant generates clean, renewable energy for thousands of homes. The project implements cutting-edge solar technology and smart grid integration.",
    technologies: [
      "Solar Panels",
      "Smart Grid",
      "Energy Storage",
